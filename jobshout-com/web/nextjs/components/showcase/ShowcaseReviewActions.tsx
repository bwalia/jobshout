...
import { moderateAppAction } from "@/app/showcase/actions";
import { Button, Textarea } from "@/components/ui";
import type { AppStatus } from "@/lib/showcase";
...
export function ShowcaseReviewActions({
  ...
  const [state, action] = useFormState(moderateAppAction, EMPTY_FORM_STATE);
      ...
      {rejecting ? (
        <div>
          ...
          <Textarea
            ...
            rows={3}
            className="mt-2"
            placeholder="The demo link goes to a different product than the repository."
        ...
        {status === "published" ? (
          <>
            <ActionButton
              ...
              label={featured ? "Unfeature" : "Feature on the showcase"}
            />
