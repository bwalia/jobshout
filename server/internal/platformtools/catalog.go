...
var humanLabels = map[string]string{
	...
	"career_evaluate":       "Evaluating the role…",
	"career_triage":         "Triaging the posting…",
	"career_scan":           "Scanning job boards…",
	"career_pipeline_list":  "Looking up the pipeline…",
	"career_tracker_list":   "Looking up the tracker…",
	"career_set_status":     "Updating tracker status…",
	"career_profile_get":    "Opening the career profile…",
	"career_profile_update": "Updating the career profile…",
	"career_intake":         "Reading the document…",
	"career_doctor":         "Checking career health…",
	"career_blacklist_add":  "Updating the blacklist…",
	"career_cover_letter":   "Drafting the cover letter…",
	"career_tailor_cv":      "Tailoring the CV…",
	"career_email_draft":    "Drafting the application email…",
	"career_followup":       "Drafting a follow-up…",
	"career_interview_prep": "Preparing interview notes…",
	"career_story_match":    "Matching STAR stories…",
	"career_offer_prep":     "Walking the offer…",
	"career_salary_gap":     "Comparing compensation…",
	"career_upskill":        "Finding skill gaps…",
	"career_contact":        "Drafting a contact note…",
	"career_batch":          "Evaluating the pipeline…",
	"career_deep":           "Researching the company…",
	"career_patterns":       "Checking career patterns…",
